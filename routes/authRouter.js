...
import { register, login, updateUser, updatePassword, getProfile, changeProfilePhoto, deleteUserById, getAllUsers, logout, getKecamatanList } from "../controllers/authController.js";
...
authRouter.get("/getKecamatanList", getKecamatanList);
